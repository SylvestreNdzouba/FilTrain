...
public class ToursArriveeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<String> train_date_list = ToursActivity.train_arrivee_Date;
        ArrayList<String> train_direction_list = ToursActivity.train_arrivee_Direction;
        ArrayList<String> train_type_list = ToursActivity.train_arrivee_Type;
        ArrayList<String> train_number_list = ToursActivity.train_arrivee_Nombre;
