...
public class BordeauxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayoutAdapter.addFragment(new BordeauxDepartFragment(), "Départs");
        tabLayoutAdapter.addFragment(new BordeauxArriveeFragment(), "Arrivées");
    ...
    //méthode récupère l'heure et la date actuelle
    ...
    public String retrieveDepartures(){
        ...
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/-0.556697;44.825873/departures?datetime="+generateTime();
    ...
    public String retrieveArrivals(){
        ArrayList<String> lines = new ArrayList<String>();
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/-0.556697;44.825873/arrivals?datetime="+generateTime();
