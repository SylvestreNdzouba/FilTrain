...
public class PassageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //longitude = getIntent().getExtras().getDouble("Longitude", Double.parseDouble("defaultKey"));
        //latitude = getIntent().getExtras().getDouble("Latitude", Double.parseDouble("defaultKey"));
        longitude = ProPassageActivity.longitude;
        latitude = ProPassageActivity.latitude;
        ...
        tabLayoutAdapter.addFragment(new DepartFragment(), "Départs");
        tabLayoutAdapter.addFragment(new ArriveeFragment(), "Arrivées");
    ...
    public String retrieveDepartures(){
        ...
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/0.693703;47.389781/departures?datetime="+generateTime();
    ...
    public String retrieveArrivals(){
        ArrayList<String> lines = new ArrayList<String>();
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/0.693703;47.389781/arrivals?datetime="+generateTime();
