...
public class ParisMontActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayoutAdapter.addFragment(new ParisMontDepartFragment(), "Départs");
        tabLayoutAdapter.addFragment(new ParisMontArriveeFragment(), "Arrivées");
    ...
    public String retrieveDepartures(){
        ...
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/2.320514;48.841172/departures?datetime="+generateTime();
    ...
    public String retrieveArrivals(){
        ArrayList<String> lines = new ArrayList<String>();
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/2.320514;48.841172/arrivals?datetime="+generateTime();
