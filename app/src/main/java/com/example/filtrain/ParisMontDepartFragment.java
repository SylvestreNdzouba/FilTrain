...
public class ParisMontDepartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<String> train_date_list = ParisMontActivity.train_depart_Date;
        ArrayList<String> train_direction_list = ParisMontActivity.train_depart_Direction;
        ArrayList<String> train_type_list = ParisMontActivity.train_depart_Type;
        ArrayList<String> train_number_list = ParisMontActivity.train_depart_Nombre;
