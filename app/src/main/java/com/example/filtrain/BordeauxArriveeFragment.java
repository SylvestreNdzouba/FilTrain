...
public class BordeauxArriveeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<String> train_date_list = BordeauxActivity.train_arrivee_Date;
        ArrayList<String> train_direction_list = BordeauxActivity.train_arrivee_Direction;
        ArrayList<String> train_type_list = BordeauxActivity.train_arrivee_Type;
        ArrayList<String> train_number_list = BordeauxActivity.train_arrivee_Nombre;
        ...
        //cette boucle permet d'afficher tour à tour les prochaines arrivées
        for(int i=0; i<10; i++) {
