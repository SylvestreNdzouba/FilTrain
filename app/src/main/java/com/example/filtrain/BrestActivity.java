...
public class BrestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayoutAdapter.addFragment(new BrestDepartFragment(), "Départs");
        tabLayoutAdapter.addFragment(new BrestArriveeFragment(), "Arrivées");
    ...
    public String retrieveDepartures(){
        ...
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/-4.478903;48.3881/departures?datetime="+generateTime();
    ...
    public String retrieveArrivals(){
        ArrayList<String> lines = new ArrayList<String>();
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/-4.478903;48.3881/arrivals?datetime="+generateTime();
