...
public class LilleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayoutAdapter.addFragment(new LilleDepartFragment(), "Départs");
        tabLayoutAdapter.addFragment(new LilleArriveeFragment(), "Arrivées");
    ...
    public String retrieveDepartures(){
        ...
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/3.075796;50.639224/departures?datetime="+generateTime();
    ...
    public String retrieveArrivals(){
        ArrayList<String> lines = new ArrayList<String>();
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/3.075796;50.639224/arrivals?datetime="+generateTime();
