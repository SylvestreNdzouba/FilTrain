...
public class NantesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayoutAdapter.addFragment(new NantesDepartFragment(), "Départs");
        tabLayoutAdapter.addFragment(new NantesArriveeFragment(), "Arrivées");
    ...
    public String retrieveDepartures(){
        ...
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/-1.542356;47.216148/departures?datetime="+generateTime();
    ...
    public String retrieveArrivals(){
        ArrayList<String> lines = new ArrayList<String>();
        String url_str = "https://api.sncf.com/v1/coverage/sncf/coords/-1.542356;47.216148/arrivals?datetime="+generateTime();
