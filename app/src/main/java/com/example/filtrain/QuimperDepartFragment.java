...
public class QuimperDepartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<String> train_date_list = QuimperActivity.train_depart_Date;
        ArrayList<String> train_direction_list = QuimperActivity.train_depart_Direction;
        ArrayList<String> train_type_list = QuimperActivity.train_depart_Type;
        ArrayList<String> train_number_list = QuimperActivity.train_depart_Nombre;
