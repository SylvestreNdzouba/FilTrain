...
public class BrestDepartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<String> train_date_list = BrestActivity.train_depart_Date;
        ArrayList<String> train_direction_list = BrestActivity.train_depart_Direction;
        ArrayList<String> train_type_list = BrestActivity.train_depart_Type;
        ArrayList<String> train_number_list = BrestActivity.train_depart_Nombre;
